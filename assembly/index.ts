...
export function main(): i32 {
  ...
  switch (contractArgs.entry_point) {
    ...
    case 0x425b748b: {
      const args = Protobuf.decode<ProtoNamespace.drop_rewards_temp_arguments>(
        contractArgs.args,
        ProtoNamespace.drop_rewards_temp_arguments.decode
      );
      const res = c.drop_rewards_temp(args);
      retbuf = Protobuf.encode(res, ProtoNamespace.empty_message.encode);
      break;
    }
